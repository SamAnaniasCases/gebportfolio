...
- **Core Tech Stack**: Astro v7.1.1 (`@astrojs/cloudflare` SSR adapter) + React 19 + `turn-arbiter` (Chess Engine) + PartyKit (Edge Chat) + TypeScript (strict) + Tailwind CSS v4 (CSS-first config) + pnpm.
...
- **Read First**: `/docs/README.md`, `/docs/AI-Guidelines.md`, `/docs/engineering/ContentStyleGuide.md`, `/docs/CodingStandards.md`, `/docs/plans/README.md`.
```
